<!-- <style lang="scss" scoped>
  ...
  function validate(){
    ...
    console.log(empty_keys, required)
    const errors = empty_keys.filter(f => required.includes(f));
    state.errors = [ ...errors ];
            ...
            <div class="swizard__radio">
              ...
              <div class="swizard__radio__items">
                <div class="swizard__radio__items__item">
                  <input id="self_assesment_yes" type="radio" v-model="form[0].self_assesment" name="self_assesment" :value="true" />
                  <label for="self_assesment_yes"><span>Yes </span></label>
                </div>
                <div class="swizard__radio__items__item">
                  <input id="self_assesment_no" type="radio" v-model="form[0].self_assesment" name="self_assesment" :value="false" />
            ...
            <div class="swizard__years">
              <div class="swizard__years__items">
                ...
                <div class="swizard__years__items__item">
                  ...
                  <input type="number" v-model="form[0].year_2019" class="swizard__years__items__item__box hide-arrows" />
              ...
              <div class="swizard__years__items">
                ...
                <div class="swizard__years__items__item">
                  <span class="swizard__years__items__item__left-icon">£</span>
                  <input type="number" v-model="form[0].year_2020" class="swizard__years__items__item__box hide-arrows" />
                  <span class="swizard__years__items__item__right-icon"
                    ><IconInfo
                  /></span>
                </div>
              ...
              <div class="swizard__years__items">
                ...
                <div class="swizard__years__items__item">
                  <span class="swizard__years__items__item__left-icon">£</span>
                  <input type="number" v-model="form[0].year_2021" class="swizard__years__items__item__box hide-arrows" />
                  <span class="swizard__years__items__item__right-icon"
                    ><IconInfo
                  /></span>
                </div>
              ...
              <div class="swizard__years__items">
                ...
                <div class="swizard__years__items__item">
                  <span class="swizard__years__items__item__left-icon">£</span>
                  <input type="number" v-model="form[0].year_2022" class="swizard__years__items__item__box hide-arrows" />
                  <span class="swizard__years__items__item__right-icon"
                    ><IconInfo
                  /></span>
                </div>
              ...
              <HasError field="year" :errors="state.errors" message="Please fill at least " />
            </div>
            <div class="swizard__radio">
              <p>
