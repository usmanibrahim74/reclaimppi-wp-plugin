<!-- <style lang="scss" scoped>
  ...
  let state = reactive({
    ...
    required: [
      ...
      ['name','dob'],
      ['email','phone','address','postcode','agree']
    ],
    form: [
      {
        self_assesment: null,
        ...
        <div class="swizard">
          ...
          <div class="swizard__step" v-if="state.step == 3">
            ...
            <div class="swizard__input">
              <p>Email</p>
              <div class="swizard__input__item">
                <input type="text" v-model="state.form[2].email" class="swizard__input__item__box" />
              </div>
            ...
            <div class="swizard__input">
              <p>Phone Number</p>
              <div class="swizard__input__item">
                <input type="text" v-model="state.form[2].phone" class="swizard__input__item__box" />
              </div>
            ...
            <div class="swizard__input">
              <p>Address</p>
              <div class="swizard__input__item">
                <input type="text" v-model="state.form[2].address" class="swizard__input__item__box" />
              </div>
            ...
            <div class="swizard__input">
              <p>Postcode</p>
              <div class="swizard__input__item">
                <input type="text" v-model="state.form[2].postcode" class="swizard__input__item__box" />
              </div>
          ...
          <div class="swizard__step" v-if="state.step == 4">
            ...
            <div class="swizard__input">
              ...
              <div class="swizard__input__item">
                <input v-model="state.form[3].referal_code" class="swizard__input__item__box" />
              </div>
            </div>
            <div class="swizard__input">
