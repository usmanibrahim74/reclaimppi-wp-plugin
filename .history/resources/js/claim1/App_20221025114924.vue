<!-- <style lang="scss" scoped>
  ...
  function validate(){
    const required = state.required[state.step-1];
    const form = state.form[state.step-1];
    const empty_keys = Object.keys(form.filter(([_, v]) => v == null || v == ""))
            ...
            <div class="swizard__radio">
              ...
              <div class="swizard__radio__items">
                <div class="swizard__radio__items__item">
                  <input id="self_assesment_yes" type="radio" name="self_assesment" :value="true" />
                  <label for="self_assesment_yes"><span>Yes </span></label>
                </div>
                <div class="swizard__radio__items__item">
                  <input id="self_assesment_no" type="radio" name="self_assesment" :value="false" />
                  <label for="self_assesment_no">No</label>
                </div>
              </div>
              <p class="text-danger" v-if="hasError('self_assesment')">This field is required</p>
            </div>
            <div class="swizard__title">
