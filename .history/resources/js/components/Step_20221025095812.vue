...
<template>
    <div
            class="
                  ...
                  "
            :class='{"before:block before:absolute before:top-1/2 before:left-1/2 before:-translate-1/2 before:bg-red-200 before:h-[3px] before:w-full z-10": !props.isLastStep}'
                  >
            <p
