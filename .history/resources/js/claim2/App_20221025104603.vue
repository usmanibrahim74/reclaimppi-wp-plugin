      ...
      <div class="mx-auto ">
        ...
        <div class="my-2.5 max-w-[650px] mx-auto p-5 bg-[#FEF9F2]" v-if="state.step == 1">
          ...
          <div class="">
            ...
            <div class="flex">
              <div class="mr-12">
                <input id="radio1" class="hidden" type="radio" name="year" />
                <label for="radio1" 
                class="flex items-center before:inline-block before:w-2.5 before:h-2.5 before:p-1 
                        before:mr-2.5 before:bg-clip-content before:border before:border-solid-[#bbbbbb] 
                        before:rounded-full before:box-content"
                 ><span>Yes </span></label>
              </div>
