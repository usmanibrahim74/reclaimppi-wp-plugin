        ...
        <div class="my-2.5 max-w-[650px] mx-auto p-5 bg-[#FEF9F2]" v-if="state.step == 1">
          ...
          <div class="">
            ...
            <div class=" mb-4">
                ...
                <input id="" type="radio" name="" value="" class="h-4 w-4 mr-2 border-gray-300" >
                United States
                </label>
            </div>
            <div class="flex">
              <div class="mr-12">
                <input id="radio1" class="inline-block w-2.5 h-2.5 p-1 
                        mr-2.5 bg-clip-content border border-solid-[#bbbbbb] checked:bg-green-500" type="radio" name="year" />
                <label for="radio1" 
