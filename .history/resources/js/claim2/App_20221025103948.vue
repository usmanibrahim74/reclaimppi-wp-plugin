          ...
          <div class="">
            ...
            <div class="flex">
              <div class="mr-12">
                ...
                <label for="radio1" 
                class="before:inline-block before:w-2.5 before:h-2.5 before:p-1 before:mr-2.5 before:bg-clip-content before:border before:border-solid-[#bbbbbb] before:rounded-full"
                 ><span>Yes </span></label>
              </div>
