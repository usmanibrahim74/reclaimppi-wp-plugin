      ...
      <div class="mx-auto ">
        ...
        <div class="my-2.5 max-w-[650px] mx-auto p-5 bg-[#FEF9F2]" v-if="state.step == 1">
          ...
          <div class="">
            ...
            <div class=" mb-4">
                <label for="" class="flex items-center text-sm font-medium text-gray-900 block">
                <input id="" type="radio" name="" value="" class="h-4 w-4 mr-2 border-gray-300 focus:ring-2 focus:ring-green-500" >
                United States
                </label>
            </div>
            <div class="flex">
