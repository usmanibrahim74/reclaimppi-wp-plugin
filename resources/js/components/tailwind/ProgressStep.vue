<template>
    <div class="w-full relative">
        ...
        <div
            class="border-2 bg-white relative z-10 rounded-full h-10 w-10 mx-auto flex items-center justify-center"
            :class="[
                current > step ? 'bg-green-400 border-green-400' : '',
                current == step
        ...
        <div
            ...
            :class="[current > step ? 'bg-green-400' : 'bg-gray-300']"
            v-if="!isLast"
        ></div>
    </div>
</template>
